...
2. Run [`database/setup.sql`](database/setup.sql) to initialize tables and indexes.
3. *(Optional)* Run [`database/seed.sql`](database/seed.sql) to insert sample NCPOR expeditions, publications, and datasets.
